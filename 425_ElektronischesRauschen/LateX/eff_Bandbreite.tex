...
sind in \cref{tab:eff_Bandbreite} dargestellt. Diesen Daten werden in einem $G(f)$ gegen $log_{10}(f)$-Diagramm aufgetragen
...
Die Unsicherheit von $\Delta f_{eff}$ wird hauptsächlich durch die Unsicherheiten der Grenzfrequenzen
 $f_{low}$ und $f_{high}$ beeinflusst. Daraus ergibt sich eine Unsicherheit von etwa $\qty{0.46}{\kilo\hertz}$.
