...
\ihead{\textbf{V401: Elektronische Übergänge an Atomen}}			% inner header
\chead{}						% center header
...
\center\textsc{\LARGE }\\[1.5cm] % Name of your university/college
...
%	TITLE SECTION
\HRule\\[0.4cm]
{ \huge \bfseries Versuch 401: Elektronische Übergänge \\[0.3cm] an Atomen}\\[0.4cm] % Title of your document
\HRule\\[0.2cm]
...
{\large Versuchsdurchführung\, 1/2. Dezember 2025 }\\[8cm] % Date, change the \today to a set date if you want to be precise
...
% chktex-file 1   % to surpress spacing warning
\end{titlepage}
%\normalfont
\tableofcontents
\clearpage
