% !TEX root =/home/jaalna/P4_WS2526/402_QuantelungVonEnergie/LateX/main.tex
% !TEX root = /home/jaffar/Desktop/P4_WS2526/402_QuantelungVonEnergie/LateX/main.tex
\documentclass[%
...
\ihead{\textbf{V402: Quantelung von Energie}}			% inner header
\chead{}						% center header
...
%	TITLE SECTION
\HRule \\[0.4cm]
{ \huge \bfseries Versuch 402: Quantelung von Energie }\\[0.4cm] % Title of your document
\HRule \\[0.2cm]
...
{\large Versuchsdurchführung\, 15/16. Dezember 2025 }\\[8cm] % Date, change the \today to a set date if you want to be precise
